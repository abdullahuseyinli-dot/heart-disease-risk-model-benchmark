...
- [Independent readmission evaluation](READMISSION_OUTER_V3_RESULT.md)
- [Synthetic mechanism result](SYNTHETIC_V3_RESULT.md)
- [eICU demo pipeline smoke test](EICU_DEMO_SMOKE_RESULT.md)
...
- [Historical reproducibility record](REPRODUCIBILITY.md)
- [ShiftGuard v1 protocol](SHIFTGUARD_V1_PROTOCOL.md)
- [ShiftGuard development result](SHIFTGUARD_DEVELOPMENT_RESULT.md)
- [Literature matrix at study time](LITERATURE_MATRIX.md)
- [Limitations recorded with the study](LIMITATIONS.md)

These files are hash-bound records of the protocol and interpretation at the
time of execution. Pre-execution or forward-looking wording in them is
historical context, not the current repository status or a public roadmap.
...
the provenance of the final reports. Their presence does not reopen a consumed
evaluation or change its evidence class.
